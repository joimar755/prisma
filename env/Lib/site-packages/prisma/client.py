...
SCHEMA_PATH = Path('C:/Users/Joimar/Documents/prisma/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\Joimar\\AppData\\Local\\npm-cache\\_npx\\55ad0b431757dc30\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    def __init__(
        ...
        *,
        ...
        self._set_generated_properties(
            ...
            preview_features=set(['driverAdapters']),
    ...
    def _default_datasource(self) -> Datasource:
        return {
            'name': 'db',
            'url': OptionalValueFromEnvVar(**{'value': 'postgresql://control_hty2_user:8hlMf9vMThXSOkD59kpQnl8YjvOp0ooC@dpg-cti3l856l47c738ep7ag-a.oregon-postgres.render.com:5432/control_hty2', 'fromEnvVar': None}).resolve(),
            'source_file_path': 'C:/Users/Joimar/Documents/prisma/prisma/schema.prisma',
        }
