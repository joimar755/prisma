...
SCHEMA_PATH = Path('/home/joimar/Documentos/prisma/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'debian-openssl-3.0.x': '/home/joimar/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-debian-openssl-3.0.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    venta: 'actions.VentaActions[models.Venta]'
    detalle: 'actions.DetalleActions[models.Detalle]'
    ...
    def __init__(
        ...
        *,
        ...
        self.venta = actions.VentaActions[models.Venta](self, models.Venta)
        self.detalle = actions.DetalleActions[models.Detalle](self, models.Detalle)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            'name': 'db',
            'url': OptionalValueFromEnvVar(**{'value': None, 'fromEnvVar': 'DATABASE_URL_1'}).resolve(),
            'source_file_path': '/home/joimar/Documentos/prisma/prisma/schema.prisma',
        }
...
class Batch:
    ...
    venta: 'VentaBatchActions'
    detalle: 'DetalleBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.venta = VentaBatchActions(self)
        self.detalle = DetalleBatchActions(self)
